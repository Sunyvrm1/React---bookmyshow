    ...
    <>
      <footer>
        ...
        <div className="footerText">
          <div className="boxWidth">
            <p className="footerTitle">TOP MOVIES TO WATCH ONLINE</p>
            <p className="footerPara">
              Spider-Man: Across The Spider-Verse | Dune: Part Two | Migration |
              Wonka | Batman: The Long Halloween Part 1 | Peter Grill and the
              Philosophers Time Super Season (S1) EP11 | Welcome To Demon School
              Iruma Kun Season 3 - Episode 15 | 47 Dhansukh Bhawan | The Roundup
              | A Mighty Heart
            </p>
            <p className="footerTitle">TOP ONLINE PREMIERE MOVIES</p>
            <p className="footerPara">
              Jawanum Mullappoovum | Rewind | The Climbers | The Holdovers |
              Eternal Sunshine of the Spotless Mind | The Book Of Clarence |
              Winter Sleep | The Invitation | Madame Web | Hatching
            </p>
            <p className="footerTitle">COUNTRIES</p>
            <p className="footerPara">
